...
},
{
  ...
  flow: [
    ...
    { t: "p", text: "In the scene above, once it unlocks, pick patrol A then B, reactive, and add the gust. This is the counter case, because memory is not evil: the drone reaches A, the wind pushes it three metres off, and on the next tick FlyTo A is asked again, answers Running, and drags it back. It never reaches B. With memory, A stays done." },
